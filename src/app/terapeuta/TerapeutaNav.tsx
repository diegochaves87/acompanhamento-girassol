  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 left-5 z-40 w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-opacity hover:opacity-90"
      ...
      >
        <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
          <span className="text-white font-bold text-base tracking-tight">Jornada Terapêutica</span>
          <button
            onClick={() => setOpen(false)}
