        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-5 mb-5">
            ...
            <img
              src="/Foto-Thais.jpeg"
              alt="Thaís Freitas"
              className="w-28 h-28 rounded-2xl object-cover object-top flex-shrink-0 self-start"
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs font-medium mt-2 transition-opacity hover:opacity-70"
                style={{ color: "#E1306C" }}
              >
