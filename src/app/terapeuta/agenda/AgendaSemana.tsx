        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex gap-1 rounded-xl p-1" style={{ backgroundColor: "rgba(255,255,255,0.12)" }}>
              ...
              {/* Nova Sessão só aparece na barra de abas em mobile */}
              <Link
                href="/terapeuta/agenda/sessoes/nova"
                className="md:hidden flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold"
          ...
          <div className="relative hidden md:flex items-center gap-3 flex-shrink-0">
            ...
            {/* Nova sessão só visível no desktop */}
            <Link
              href="/terapeuta/agenda/sessoes/nova"
              className="hidden md:flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-white transition-opacity hover:opacity-90"
