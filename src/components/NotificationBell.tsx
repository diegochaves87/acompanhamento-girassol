...
// SVG paths matching lucide icons, using brand colors from spec
function typeConfig(type: string): { bg: string; color: string; path: string } {
  switch (type) {
    case "cpf_missing":
      // AlertTriangle — amarelo #FFBA3D
...
function NotifIcon({ type }: { type: string }) {
  const { bg, color, path } = typeConfig(type);
  return (
